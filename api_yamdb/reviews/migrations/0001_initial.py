# Generated by Django 3.2 on 2023-09-24 12:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, null=True, unique=True, validators=[django.core.validators.RegexValidator(message="Username must be Alphanumeric or containany of the following: '.@+-' ", regex='^[\\w.@+-]+\\Z')], verbose_name='Имя пользователя')),
